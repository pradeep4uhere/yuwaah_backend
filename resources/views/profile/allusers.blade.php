        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="premium-listing-card">
                ...
                <div class="premium-listing-topbar">
                    <div>
                        <h3 class="premium-section-title mb-1">User Directory</h3>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <div class="premium-name-cell">
                                            ...
                                            <div>
                                                <div class="premium-name">{{ $item['name'] }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td nowrap="nowrap">
                                        <span class="premium-text-muted">{{ $item['mobile'] ?: 'N/A' }}</span>
                                    </td>

                                    <td nowrap="nowrap">
                                        @if($item['id'] == 1)
                                            <span class="premium-pill admin">Admin</span>
                                        @else
                                            <span class="premium-pill user">User</span>
                                        @endif
                                    </td>
                                    ...
                                    <td nowrap="nowrap">
                                        <div class="premium-action-group">
                                            <a href="#" class="premium-action-btn edit-btn">Edit</a>

                                            @if($item['id'] != 1)
                                                <a href="#" class="premium-action-btn delete-btn">Delete</a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
