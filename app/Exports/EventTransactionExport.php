    ...
    public function query()
{
    ...
    $query = DB::connection('mysql2')
        ...
        // event_transaction_comments data is currently unavailable.
        // Therefore latest comment fields will be exported as NULL.
        ->where(function ($q) {
            $q->where('yuwaah_sakhi.csc_id', '!=', 'Sandbox_Testing')
              ->orWhereNull('yuwaah_sakhi.csc_id');
        })
        ...
        ->select(
            ...
            // Existing comment in event_transactions
            'event_transactions.comment',

            'event_transactions.updated_at',

            // event_transaction_comments table data is lost,
            // so export NULL values instead.
            DB::raw('NULL as latest_status'),
            DB::raw('NULL as latest_comment'),
            DB::raw('NULL as latest_comment_type')
        )
